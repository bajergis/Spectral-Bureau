...
#endif
            var sessionState =
                ConnectionSettings.Instance.GameConnectionState != GameConnectionState.NotConnected && ConnectionSettings.Instance.SessionCode != null
                ? $"Session-Code: <b>{ConnectionSettings.Instance.SessionCode}</b> ({interactionTypeText} to copy) | Role: <b>{networkRole}</b>"
                : "No Session";
